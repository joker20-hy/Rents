  ...
  <modal name="user-profile" class="p-2" :width="500" @before-close="leaveEdit">
    ...
    <div v-if="user.profile" class="profile-detail">
      <div class="form-group text-center">
        <img :src="user.profile.image==null?'/images/default.svg':user.profile.image" alt="" style="width: 90px;height: 90px;border-radius: 50%;">
        <br>
        <button v-show="edit" type="button" class="btn" onclick="clickTarget('#profile-image')">
...
export default {
  ...
  methods: {
    ...
    update () {
      ajax().put(`/api/user/${this.user.id}/profile`, this.user.profile)
      .then(res => {
        this.leaveEdit()
