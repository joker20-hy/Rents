<template>
  <div contain-box class="mt-3 mb-5">
    ...
    <transition-group name="slide-fade">
      <div v-for="payment in payments" :key="payment.id" class="list-item row mx-0">
        ...
        <div class="col-4 px-0 text-right">
          <router-link :to="{name: 'payment-room-detail', params: {id: payment.id}}" class="btn text-primary">Chi tiết</router-link>
        </div>
      </div>
    </transition-group>
    <div class="text-center text-muted mt-3">
      Danh sách hóa đơn trọ thường kỳ do chủ nhà trọ tạo
    </div>
