<template>
  <div class="modal fade" id="logout-confirm" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body text-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 295.996 295.996" fill="var(--blue)" width="50px" height="50px">
            ...
            <br>
            <br>
            <button type="button" class="btn btn-outline-danger" onclick="logout()" data-dismiss="modal">Xác nhận</button>
